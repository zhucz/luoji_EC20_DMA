...
{	
	...
	u32 time=0; 
	// if(RTC_DateStruct.Year<1980)
	//RTC_DateStruct.Year=1980; 
	time=(2000+RTC_DateStruct.Year-1980)<<25;
	time|=(RTC_DateStruct.Month)<<21;
	time|=(RTC_DateStruct.Date)<<16;	
	time|=(RTC_TimeStruct.Hours)<<11;	
	time|=(RTC_TimeStruct.Minutes)<<5;
	time|=(RTC_TimeStruct.Seconds/2);
